    ...
    return(
        ...
        <ScrollRevealSection id={"Service2"} backgroundColor={"#E9F9EE"} height={"auto"}>
            ...
            <div className="Services-Container">
                <img src="https://i.postimg.cc/bv4yHDnJ/drone-spraying-fertilizer-vegetable-green-plants-agriculture-technology-farm-automation-2.jpg" alt="Drone-Image" className="Service-Images"/>
        ...
        <ScrollRevealSection id={"Service3"} backgroundColor={"#E9F9EE"} height={"auto"}>
            ...
            <div className="Service-Text2">
                    <h1 className="Service-Card-Head">AI Soil Testing</h1>
                ...
                <img src="https://i.postimg.cc/PJz5g2Vw/images-14.jpg" alt="Drone-Image" className="Service-Images"/>
                 </div>
        </ScrollRevealSection>
