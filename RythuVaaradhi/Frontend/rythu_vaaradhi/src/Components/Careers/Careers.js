            ...
            return (
               ...
               <>
                  ...
                  <div className="WorkWithUs">
                        ...
                        <a href="https://wa.me/message/J6Y7TZ7LEU3QA1" target="_blank" rel="noopener noreferrer" style={{color:"#ffffff",alignSelf:"flex-start"}}> <button className="JoinButton">మాతో చేరండి</button></a>
                        </div>
                        </div>
                        <div className="LabourWork">
                        ...
                        <a href="https://wa.me/message/J6Y7TZ7LEU3QA1" target="_blank" rel="noopener noreferrer" style={{color:"#ffffff",alignSelf:"flex-start"}}> <button className="JoinButton">మాతో చేరండి</button></a></div>
                        </div>
                        <div className="LabourWork">
